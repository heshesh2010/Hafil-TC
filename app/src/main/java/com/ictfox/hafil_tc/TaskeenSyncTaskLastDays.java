...
public class TaskeenSyncTaskLastDays extends AsyncTask<Void, Void, String>{
	Activity mActivity;
	Context context;
...
private final String NAMESPACE = "http://tempuri.org/";
	...
	public TaskeenSyncTaskLastDays(Activity activity, ProgressDialog progressDialog,
                                   Context context, String Username, String plateNumber, String schoolName, String address, String driverName, String driverMobile, String MinstyNumber, String FleetNumber, String DriverID, String NumberOfStudent, String ActionDate, String TaskeenType, String note, String TaskeenArea, String TaskeenCity) {
		super();
	...
	protected void onPostExecute(String result) {
        ...
        if(result.equals("0")){
            ...
            try {
                ...
                dbHandler.UpdateTaskeen(this.Username, plateNumber, schoolName,  this.address, driverName, driverMobile, this.minstryNumber, FleetNumber, this.NationalId, this.NumberOfStudent, this.ActionDate, 1);
