...
public class LocationsDataBase extends AsyncTask<Void, Void, String>{
	...
	public LocationsDataBase(Activity activity, ProgressDialog progressDialog,
 Context context, String mistrayNum) {
	...
	protected void onPostExecute(String result) {
		...
		TextView schoolName = (TextView) mActivity.findViewById(R.id.textView5); 
		TextView adminnamepostion = (TextView) mActivity.findViewById(R.id.textView7);
		...
		alertDialog.setMessage("الرقم المدخل خاطئ هل تود اعاده المحاولة");
