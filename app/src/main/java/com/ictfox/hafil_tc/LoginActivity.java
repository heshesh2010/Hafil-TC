        ...
        public void onClick(View v) {
            ...
            if(prefs.getBoolean("firstRun", true) && isOnline()) {
                ...
                try {
                    ...
                    if(Integer.parseInt(dbHandler.CheckLogin(login, pass)) > 0) {
                        int user2 = Integer.parseInt(dbHandler.CheckLogin(login, pass));
                        progressDialog.dismiss();
                        Toast.makeText(LoginActivity.this, String.valueOf(user2), Toast.LENGTH_LONG).show();
                        prefs.edit().putString("UserID", String.valueOf(user2)).apply();
...
//progressDialog.dismiss();
                try {
                    if(Integer.parseInt(dbHandler.CheckLogin(LoginId.getText().toString(), LoginPass.getText().toString())) > 0) {
                        int user2 = Integer.parseInt(dbHandler.CheckLogin(LoginId.getText().toString(), LoginPass.getText().toString()));
                        Toast.makeText(LoginActivity.this, String.valueOf(user2), Toast.LENGTH_LONG).show();
                        prefs = PreferenceManager
                                .getDefaultSharedPreferences(LoginActivity.this);
